         ...
         <div class="row">
           ...
           <div class="col-lg-12">
             <div class="img-wrap" id="new-custom-third-val-id">
              <iframe id='3dviewerplayer' type='text/html' width='640' height='480' src='https://www.3dvieweronline.com/members/Iddd82d58268453ca1c56996aa87e97fca/cwcXhHrdKFIn67v' frameborder='0' scrolling='no' allowfullscreen webkitallowfullscreen mozallowfullscreen></iframe>
             </div>
           </div>
         </div>
          <input type="button" name="previous" class="previous action-button-previous button" value="Back" />
           ...
           <div class="offset-lg-3 col-lg-6 text-center">
             ...
             <ul class="Canopy1 checking-radio-panel-of-slap-class">
              <input type="hidden" id="mount_answer_hidden_id" name="mount_answer_hidden" value="no">
                ...
                <li>
                 <input type="radio"  name="bracket" value="no" >No
                </li>
             </ul>
        ...
        <fieldset>
         <div class="row">
           <div class="offset-lg-3 col-lg-6 text-center">
             ...
             <div class="canopy-note-select-panel-class">
         ...
         <div class="row">
           <div class="col-lg-12 text-center">
            ...
            <label for="">Select the action ( Take Printout, Generate PDF or Send Email )</label>   
             <ul class="print-sec">
               <li><a href="javascript:;" onClick="window.print()"> <i class="fas fa-print"></i> Print</a></li>
               <li><a href="javascript:;" target="_blank"><i class="far fa-file-pdf"></i> PDF</a></li>
               <li><a href="#" data-toggle="modal" data-target="#myModal"><i class="far fa-envelope"></i> Email</a></li>
             </ul>     
           </div>  
         </div>
